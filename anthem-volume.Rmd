...
mtd_start_2026 <- floor_date(march_end_2026, "month")

num_days <- as.numeric(march_end_2026 - march_start_2026) + 1

mtd_end_2025 <- as.Date(paste0("2025-", sprintf("%02d", month(march_end_2026 + 1)), "-",sprintf("%02d", day(march_end_2026 + 1))))
